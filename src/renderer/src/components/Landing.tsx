...
import logo from '../../../../resources/simantic-logo-inverted.svg'
    ...
    <div className="absolute inset-0 flex items-center justify-center bg-background">
      <div className="w-full max-w-lg px-6">
        <div className="flex flex-col items-center gap-4 py-8">
          <img
            src={logo}
            alt={translate('auto.components.Landing.2deb0508d7', 'Simantic logo')}
            className="size-20 rounded-2xl border border-border/80 shadow-lg"
          />
          <h1 className="text-4xl font-bold text-foreground tracking-tight">
            {translate('auto.components.Landing.a46501664b', 'Simantic')}
          </h1>
