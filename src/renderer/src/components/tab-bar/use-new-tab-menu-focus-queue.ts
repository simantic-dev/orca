...
/**
 * Focus handed off after the "+" menu closes: the menu's own close animation steals focus, so the
 * target is queued and applied on the next frame, retrying briefly for terminals created async.
 */
