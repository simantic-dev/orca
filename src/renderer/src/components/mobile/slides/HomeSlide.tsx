      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5dffab53c1', 'Simantic')}
          </span>
        </div>
        <button
          type="button"
...
function OrcaLogo(): React.JSX.Element {
  return (
    <svg className="mp-orca-logo" viewBox="0 0 118 118" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
        d="M10 0h98a10 10 0 0 1 10 10v98a10 10 0 0 1-10 10H10A10 10 0 0 1 0 108V10A10 10 0 0 1 10 0Zm5 94a9 9 0 1 0 0 18 9 9 0 0 0 0-18Z"
      />
    </svg>
  )
}
